...
struct TestRegister {
    ...
    using TestBitfield = rye::Bitfield<TestRegister, std::uint8_t, 4, 4, AccessType::ReadOnly>;
    using TestBitfield2 = rye::Bitfield<TestRegister, std::uint16_t, 12, 9, AccessType::ReadOnly>;
};
